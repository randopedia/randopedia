  ...
  if (Ember.OAuth2 == undefined) {
    Ember.OAuth2 = Ember.Object.extend({
      ...
      authorize: function() {
        ...
        this.dialog = window.open(this.authorizeUri, 'Authorize', 'height=600, width=1024');
      ...
      getToken: function(tokenType) {
        
        if(tokenType !== null && typeof tokenType !== 'undefined') {
            var token = JSON.parse(window.localStorage.getItem('token-' + tokenType));
